...
#'
#'
#' @param QC_type Character or character vector. Specify QCtype to return. Must be quoted.
#' \describe{
...
#' }
#'
#' @param sample_depth Character or character vector. Filter on SampleDepth_m. If "all", returns all sample depths. If "surface" (Default),
