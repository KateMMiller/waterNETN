...
#'
#' @description This function ingests the NETN water monitoring program excel file that is exported from the FileMaker app,
#' and prepares the data for importing intp the the MS Access database. Users must specify the path and file name. The
#' function will determine whether the data is from a lake or stream based on column names. The function then exports
#' a csv file in the same filepath with '_cleaned_' and the date added to the filename. This file is ready to be imported into MS Access. Note that this function can only work with lake or stream data, not both
...
#'
#' @param excel_name Quoted name of the FileMaker export file. Must include the .xlsx file extension.
#'
