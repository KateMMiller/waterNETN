...
```{r, eval = F, class.source = "indent"}
importData(type = 'csv',
           filepath = "C:/Users/KMMiller/OneDrive - DOI/NETN/R_Dev/Water/data/records-2313941") # update filepath to your computer
```
<p class = 'indent'>
...
importData(type = 'dbfile',
           filepath = "C:/Users/KMMiller/OneDrive - DOI/NETN/R_Dev/Water/data/NETN_h3Ov4_DataPackage_202331115.accdb")
```
<p class = 'indent'>
...
knitr::include_graphics("C:/Users/KMMiller/OneDrive - DOI/NETN/R_Dev/Water/waterNETN/testing_scripts/finding_R_package.jpg")
```
...
knitr::include_graphics("C:/Users/KMMiller/OneDrive - DOI/NETN/R_Dev/Water/waterNETN/testing_scripts/ODBC_step_1.jpg")
```
...
knitr::include_graphics("C:/Users/KMMiller/OneDrive - DOI/NETN/R_Dev/Water/waterNETN/testing_scripts/ODBC_step_2.jpg")
```
...
knitr::include_graphics("C:/Users/KMMiller/OneDrive - DOI/NETN/R_Dev/Water/waterNETN/testing_scripts/ODBC_step_3.jpg")
```
...
Before FileMaker Go files are ingested into the Access database, use the ingestion script to scrub placeholder values from the .xlsx files. This script serves to convert a multitude of placeholder values to NAs when “No measurement” is selected for Datum Name and/or Discharge Method in the FileMaker Go application. Additionally, it also converts certain placeholder values to NAs when “No water sample taken” is recorded in the application. The table below shows the FileMaker Go export placeholders that are converted to NAs for both Stream and Lake applications. 
<br>
...
There are two separate code chunks for Stream and Lake data. This is due to the difference in column names when the FileMaker Go application exports the data to .xlsx files. Please use the appropriate corresponding script when cleaning the data. 
<br>
At the end of the script, there is an option to write the cleaned data back to a new .csv file. You can name the file anything you’d like – I’d suggest naming the file with the traditional naming convention (e.g. ACAD_WQ_Streams_YYYY-MM), so Access is able to ingest the file without issues. 
