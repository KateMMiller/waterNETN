...
<b style="color:red;">NEW: I updated the compiled climate data to cover 1895 up through May 2024, so you can plot historic trends beyond just the 2006-2024 monitoring period. You can also plot units in English.</b>

<p class = 'fxn'>Plot avg temp for LNETN from 1895:2024, without points and with smoothed line and span 0.1 and gridlines on y-axis, and in English units.</p>
```{r}
...
<p class = 'fxn'>Plot monthly climate data in English units for MABI from 2006:2023 (all months is default), without a smoothed line.</p>
```{r}
plotClimTrend(park = "MABI", years = 2006:2023, parameter = "all", layers = c("points", "lines"), facet_param = T, gridlines = "grid_y", units = 'eng')
```
