...
By default, this function works with Daymet data, and so is not always available for the given year. By specifying data_type = 'wstn', data from the nearest weather station is compared with Daymet data extracted from the lat/long coordinates of the nearest weather station. 
...
```{r}
plotClimRel(site = "SARASA", years = 2023:2024, parameter = "ppt", palette = "grey", averages = "norm90")
```
