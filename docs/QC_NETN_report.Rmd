...
check_null_print(tbl_ANC_mgL_99, 5, "ANC 99pct")
check_null_print(tbl_ANC_mgL_01, 5, "ANC 1pct")
check_null_print(tbl_ANC_mgL_75, 5, "ANC 75pct") 
check_null_print(tbl_ANC_mgL_25, 5, "ANC 25pct") 

cat("\n\n")
```

```{r eval = lab_v_sonde_include, results = 'asis'}
...
```{r eval = env_v_qc_include, results = 'asis'}
