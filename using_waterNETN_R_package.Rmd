...
<p class = 'fxn'>Plot smoothed surface pH for Eagle Lake for all years. </p>
```{r}
...
```{r}
plotTrend(site = "ACEAGL", parameter = "pH", years = 2023, smooth = FALSE, sample_depth = 'surface')
#++++ ENDED HERE++++ Something is resulting in multiple samples per event
```
