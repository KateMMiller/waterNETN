...
<p class = 'fxn'>Plot temperature for Eagle Lake for years 2013 - 2023 with raw sample depth, and no plot title or thermocline. </p>
```{r message = FALSE, warning = FALSE}
plotLakeProfile(site = "ACEAGL", parameter = "Temp_C", depth_type = 'raw', 
                years = 2013:2023, plot_title = FALSE, plot_thermocline = F)
