...
<p class = 'fxn'>Plot temperature for Upper Hadlock for years 2013 - 2023 corrected by elevation. </p>
```{r message = FALSE, warning = FALSE}
...
<p class = 'fxn'>Plot temperature for Eagle Lake for years 2013 - 2023 with raw sample depth, and no plot title. </p>
```{r message = FALSE, warning = FALSE}
plotLakeProfile(site = "ACEAGL", parameter = "Temp_C", depth_type = 'raw', 
                years = 2013:2023, plot_title = FALSE)
...
lakes23 <- c("ACBUBL", "ACEAGL", "ACECHO", "ACJORD", "ACLONG", "ACROUN", 
             "ACSEAL", "ACUBRK", "ACUHAD", "ACWHOL", "ACWOOD")
...
<p class = 'fxn'>Plot specific conductance for Seal Cove Pond from 2013 to 2023 and sample elevation. Uses spectral palette by default and adds site name as title by default. </p>
```{r message = FALSE, warning = FALSE}
...
pgrid <- plot_grid(tplot, doplot, pHplot, cnplot, rel_widths = c(0.95, 1, 0.95, 1))
